    ...
    return(
       ...
       <div className="flex w-full h-[1000px]">
        ...
        <div className="w-full">  
                    <div className="w-4/5 ml-[60px]">
                        <dl className="flex leading-loose items-center">
       ...
       <div className="w-full ml-[80px]">
            <p className="text-white text-[60px] font-bold !mb-[30px]">Hobbys</p>
            <ul className="flex">
                <li>
                    <img className=" w-[200px] h-[200px] object-cover border border-white rounded-full shadow-[0_0_20px_white] !mb-[10px]" src="./image/drone.png" alt="#" />
                    <p className="text-white text-[30px] text-center">ドローン撮影</p>
                </li>
                <li className="ml-[60px]">
                    <img className="w-[200px] h-[200px] object-cover border border-white rounded-full shadow-[0_0_20px_white] !mb-[10px]" src="./image/golf.jpg" alt="#" />
                    <p className="text-white text-[30px] text-center">ゴルフ</p>
                </li>
            </ul>
       </div>
       </div>
