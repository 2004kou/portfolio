...
const ReactIcons = () => {
  return (
    <div className="block w-4/5 text-center md:text-left mx-auto">
      {/* Languages */}
      <h3 className="text-white md:!text-[48px] md:font-extrabold  font-semibold !mt-5! mb-4 tracking-wide border-b-4 border-blue-500 inline-block pb-2 !text-[30px]">
        Languages
      </h3>
      <IconContext.Provider value={{ size: 40, color: "#ffffff" }}>
        <ul className="flex flex-col gap-4 !mt-4 text-center md:text-left">
          <li className="text-white flex items-center md:text-lg">
      ...
      {/* Frameworks */}
      <h3 className="text-white !text-[30px] font-extrabold !mt-8 !mb-4 tracking-wide border-b-4 border-green-500  pb-2 inline-block w-auto">
        Frameworks
      </h3>
      <IconContext.Provider value={{ size: 40, color: "#ffffff" }}>
      ...
      {/* Tools */}
      <h3 className="text-white md:!text-[48px] font-extrabold !mt-8 !mb-4 tracking-wide border-b-4 border-purple-500 inline-block pb-2 !text-[30px]">
        Tools
      </h3>
      <IconContext.Provider value={{ size: 40, color: "#ffffff" }}>
        <ul className="flex flex-col gap-4 !mt-4 text-center">
          <li className="text-white flex items-center md:text-lg leading-relaxed ">
